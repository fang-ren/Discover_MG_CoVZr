...
def plt_ternary_save(data, tertitle='',  labelNames=('Species A','Species B','Species C'), scale=100,
    ...
    """
    if sv:
        font = {'size': 96}   # Set font size for **kwargs
        figsize = (27.2, 20)
        ticksize = 48
        lnwdth = 4
        lnsty = '--'
    ...
    tax.bottom_axis_label(labelNames[1], offset=-0.09, **font)
    ...
    tax.ticks(ticks=ticks, axis='rlb', linewidth=2, clockwise=False, offset=0.03, textsize=ticksize)
