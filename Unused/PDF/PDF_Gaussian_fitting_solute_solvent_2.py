...
guess = [2.59,1,0.1,2.85,1,0.1,2.50,0,0.1,2.94,1,0.1,2.68,0,0.1,3.2,0,0.1,2.03,1,0.1]

## setting constraint
#low = (2.54,0,0,2.8,0,0,2.45,0,0,2.89,0,0,2.63,0,0,3.15,0,0,2.01,0,0,4,0,0)
#high = (2.64,100,0.2,2.9,100,0.2,2.55,100,0.2,2.99,100,0.2,2.73,100,0.2,3.25,1,0.2,2.05,100,0.2,4.6,200,10)
...
plt.plot(r, Gr)
#
#Tr = Gr + 4*np.pi*0.068*r
#background = Gaussian(r, *[0.1, 4.35, 50, 0.43])
##Tr = Tr - background
#
...
#
#Tr = Gr + 4*np.pi*0.068*r
#background = Gaussian(r, *[1.23, 3.44, 1.5, 0.32])
#Tr = Tr - background
#
#plt.plot(r, Tr, 'o', label = 'unannealed PDF')
##plt.plot(r, background)
