...
def read_data(total_num_scan, index, basefile_paths):
    ...
    while (index <= total_num_scan):
        ...
        peak_position.append(peak_info[0][0])
        peak_intensity.append(peak_info[0][1])
        peak_width.append(peak_info[0][2])
        index += 1
...
folder_path = 'C:\\Research_FangRen\\Data\\Metallic_glasses_data\\CoVZr_ternary\\1Dfiles\\high_power_15\\backgrd_subtracted_1D_batch\\Peak_fitting_GLS\\'
base_filename = 'Sample15_7thick_24x24_t30_'
total_num_scan = 441
