...
master_file_name = 'CLEANED_SampleB2_19_master_metadata.csv'
...
spectra_file_path = '..//..//data//1D_spectra//raw_1D//SampleB2_19//'
spectra_basename = 'SampleB2_19_24x24_t30_'
...
pif.dump(alloys, open('..//..//data//Json_files_Citrine//SampleB2_19_test.json','w'))